...
var halfWindowsWidth = Dimensions.get('window').width / 1.2;
var TextInput = function TextInput(_ref) {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            if (!(validation !== null && validation !== void 0 && validation.fn)) {
              _context.next = 7;
              break;
            }
            _context.next = 5;
            return validation.fn(text);
          case 5:
            e = _context.sent;
            if (e.valid === true) {
              setStatus('VALID');
  ...
  }, /*#__PURE__*/React.createElement(RNTextInput, {
  ...
  }), icon && !hidden && /*#__PURE__*/React.createElement(Icon, {
    name: icon
  })));
};
var styles = StyleSheet.create({
  ...
  input: _objectSpread(_objectSpread({}, texts.P3Medium), {}, {
    width: halfWindowsWidth,
    borderRadius: 4,
    borderWidth: 1,
    color: colors.primary[1700],
