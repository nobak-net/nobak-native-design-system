...
export var DefaultTextInput = Template.bind({});
DefaultTextInput.args = {
  config: {
    ...
    validation: {
      fn: function () {
        var _fn = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(text) {
    ...
    afterChange: function afterChange(info) {
      return console.log('After change:', info);
    }
  }
};

// Example Story: Disabled TextInput
export var DisabledTextInput = Template.bind({});
DisabledTextInput.args = {
  config: _objectSpread(_objectSpread({}, DefaultTextInput.args.config), {}, {
    disabled: true
  })
};
